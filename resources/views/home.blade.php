...
@section('content')
        <div id="carousel-example-2" class="container-fluid carousel slide carousel-fade carousel-margin"
            data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <div class="view">
                        ...
                        <img class="d-block w-100" src="{{ URL::to($banner->path) }}" alt="First slide">
                            ...
                            <div class="post-slide10">
                                <div class="card"><a href="#">
                                        <img class="image_thumb"
                                            ...
                                            title="voluptate velit esse" alt="voluptate velit esse"> <img
                                            class="img-top"
