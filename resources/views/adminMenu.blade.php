                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="dish/insert" method="POST" name="new-dish-form" id="new-dish-form" enctype="multipart/form-data">
                                    ...
                                    <input type="number" step="any" class="form-control" placeholder="Price" name="new-dish-price">
                                    <input type="number" step="any" class="form-control" placeholder="Before Discount Price" name="new-dish-discount">
                ...
                <div class="modal fade" id="editDish" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" name="edit-dish-form" id="edit-dish-form" enctype="multipart/form-data">
                                    {{@csrf_field()}}
                                    ...
                                    <input type="number" step="any" class="form-control" placeholder="Price" name="edit-dish-price">
                                    <input type="number" step="any" class="form-control" placeholder="Before Discount Price" name="edit-dish-discount">
